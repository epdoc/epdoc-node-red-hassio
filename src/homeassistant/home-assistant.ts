...
import { NO_VERSION } from 'nodes/const';
import httpAPI from './Http';
import websocketAPI, { ClientState } from './Websocket';
import { HassTags } from './types';
...
const httpMethods: string[] = ['fireEvent', 'get', 'getHistory', 'post', 'renderTemplate'];
...
export default class HomeAssistant {
  ...
  addListener(event: string, handler: { (): void }, options = { once: false }): void {
