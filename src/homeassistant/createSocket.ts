...
// const debug = (msg: string, msg2: string) => {
//   console.log('home-assistant:socket ' + msg + msg2);
// };
...
export default function createSocket({
  ...
  function connect(promResolve: (socket: HaWebSocket) => void, promReject: (err: Error) => void) {
    ...
    // @ts-ignore Need to further understand this data type
...
export function atLeastHaVersion(version: string, major: number, minor: number, patch?: number): boolean {
